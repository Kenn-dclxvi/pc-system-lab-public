...
[電源を入れていても気にならない。深夜にPCの音を測ってみる](articles/system-tuning-quiet-pc-noise.md)

電源を入れていても気にならなくなったので、スマホで音を測ってみました。スリープ時との比較と、静音PCの基準を調べた経緯です。

## これまでの調整のまとめ

[ケースの冷却を確かめてから、UVとファンの下限を詰める](articles/system-tuning-cooling-after-undervolt.md)

ケースの冷却確認、CPU・GPUの低電圧化、長時間試験の結果が、その後のファン調整にどうつながったかをまとめています。
